...
def create_dataset(input_dir, output_dir, data_type, labels_file, noviz = False):
    if osp.exists(output_dir):
        print("Output directory already exists:", output_dir)
    else:
        os.makedirs(output_dir)
    os.makedirs(osp.join(output_dir, data_type))
    ...
    out_ann_file = osp.join(output_dir, f"annotations/{data_type}_annotations.json")
    ...
    for image_id, filename in enumerate(label_files):
        ...
        out_img_file = osp.join(output_dir, data_type, base + ".jpg")
...
if __name__ == "__main__":
    ...
    create_dataset(args.input_dir, args.output_dir, args.labels, args.noviz)
